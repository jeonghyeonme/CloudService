...
GOOGLE_LOGIN_ID=$(create_resource "$ROOT_ID" "googleLogin")
echo "  /googleLogin → $GOOGLE_LOGIN_ID"
...
setup_endpoint "$GOOGLE_LOGIN_ID"    "POST"   "${PREFIX}-${STAGE}-googleLogin"        "googleLogin"
...
echo "   POST   $REST_URL/googleLogin          → googleLogin"
echo "════════════════════════════════════════"
